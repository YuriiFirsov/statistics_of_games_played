...
<div>
    <div class="w3-col w3-container" style="width:20%"></div>
    <div class="w3-col w3-container" style="width:60%">
        <form:form action="save_new_game" modelAttribute="game">
            <form:hidden path="id"/>
            <br><br>
            Введите название игры:<form:input path="name"/>
            <form:errors path="name"/>
            <br><br>
            <input class="w3-btn w3-border w3-round w3-blue" type="submit" value="Добавить">
